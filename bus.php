...
<div class="fh5co-cover" data-stellar-background-ratio="" style="background-image: url(images/bus.jpg);">
<div class="desc">
<div class="container">
<div class="row">
<div class="col-sm-5 col-md-5"><!-- <a href="index.html" id="main-logo">HOSTMYTRIPS</a> -->
<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
<center>
    <iframe class="728X90" id="iframe" src="https://partners.etravelsmart.com/bus/affiliate/728/index.php?utm_source=anjain.anjain" style="border: 1px solid #c1c1c1" scrolling="no" width="728" height="90"></iframe>&nbsp;
    <!-- <p><a class="btn btn-primary btn-lg" href="#">Get Started</a></p> -->
    </div>
</center>
<div class="tabulation animate-box"><!-- Nav tabs --></div>
</div>
</div>
</div>
</div>
